...
function createScene()
{
	...
	renderer.domElement.style = 'width:50%; height:100%; position:fixed; top:0; left:50%;';
	...
	myCamera = new THREE.PerspectiveCamera(30, window.innerWidth / window.innerHeight, 0.1, 2000);
	myCamera.position.set(40, 0, 150);
